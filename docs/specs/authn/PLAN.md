...
| `AUTHN-002` | Password persistence and bootstrap | ready | `AUTHN-001`, `TELING-001` | `AUTHN-003` | no | `plans/AUTHN-002-password-persistence-and-bootstrap.execplan.md` (accepted) |
