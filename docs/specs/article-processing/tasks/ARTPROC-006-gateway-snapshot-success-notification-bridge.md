...
- This bridge is not the final v0 success notification contract. The later extraction/summarization feature must replace it with summary-based completion.
