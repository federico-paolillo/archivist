...
| `summary-generation` | Summary Generation | in_progress | `markdown-extraction`, `worker-runtime-configuration` | [`SPEC.md`](./summary-generation/SPEC.md) | [`PLAN.md`](./summary-generation/PLAN.md) |
