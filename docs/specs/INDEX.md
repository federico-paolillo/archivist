...
| `summary-generation` | Summary Generation | draft | `markdown-extraction`, `worker-runtime-configuration` | [`SPEC.md`](./summary-generation/SPEC.md) | [`PLAN.md`](./summary-generation/PLAN.md) |
