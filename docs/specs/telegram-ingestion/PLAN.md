...
|---|---|---|---|---|---|---|
| `TELING-001` | Persistence contracts | ready | - | `TELING-002`, `TELING-003` | no | `plans/TELING-001-persistence-contracts.execplan.md` |
| `TELING-002` | Telegram webhook ingestion | blocked | `TELING-001` | `TELING-004` | true | - |
| `TELING-003` | Worker terminal notification contract | blocked | `TELING-001` | `TELING-004` | true | - |
