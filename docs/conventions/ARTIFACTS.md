...
| Markdown content | `{DATA_DIR}/articles/{article_id}/content.md` | Worker Markdown extraction stage | Current terminal success and future summarization |
| Summary JSON | `{DATA_DIR}/articles/{article_id}/summary.json` | Future summary stage | Future structured summary display |
| Summary Markdown | `{DATA_DIR}/articles/{article_id}/summary.md` | Future summary stage | Future human-readable summary display |
